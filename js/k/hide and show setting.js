    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 7,
                "vtp_includeConditions": ["list", "grapesjs\\.com"],
                "tag_id": 18
            }, {
                ...
                "priority": 6,
                "vtp_instanceDestinationId": "G-LWEFNL65W8",
                "tag_id": 27
            }, {
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    var Fg = function() {
        ...
        var a = new kb;
        a.set("containerId", 'G-LWEFNL65W8');
        a.set("version", '2');
    ...
    Kh.ne = Number("0") || 0;
    Kh.ka = "dataLayer";
    Kh.dk = "ChAI8OOJpQYQu4rwmNGN2tl2EiUAvyaRZxyTXr4EvoisJRd2TtUa0+pSgaXBBhidCFffsruWSQl3GgKDKg\x3d\x3d";
    var Nh = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var ti;
    try {
        ti = JSON.parse(vb("eyIwIjoiSU4iLCIxIjoiSU4tVE4iLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6IiJ9"))
    } catch (a) {
        N(123),
        si(2),
        ti = {}
    ...
    ;function By() {
        var a = ["&cv=2", "&rv=" + Kh.ah, "&tc=" + Oe.filter(function(b) {
            return b
        }).length];
